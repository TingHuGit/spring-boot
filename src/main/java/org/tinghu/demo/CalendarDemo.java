 ...
 * 
 * Calendar calendar = Calendar.getInstance(); // 假设求6月的最后一天 int currentMonth =
 * 6; // 先求出7月份的第一天，实际中这里6为外部传递进来的currentMonth变量 // 1
 * calendar.set(calendar.get(Calendar.YEAR), currentMonth, 1);
 * 
 * calendar.add(Calendar.DATE, -1);
 * 
 * // 获取日 int day = calendar.get(Calendar.DAY_OF_MONTH);
 * 
 * System.out.println("6月份的最后一天为" + day + "号"); } }
 */